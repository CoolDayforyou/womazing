			...
			<div className={styles.container}>
				<div className={styles.leftSide}>
					...
					<div className={styles.link}>
						<a className={styles.linkItem} href="#">© Все права защищены</a>
						<a className={styles.linkItem} href="#">Политика конфиденциальности</a>
						<a className={styles.linkItem} href="#">Публичная оферта</a>
					</div>
				</div>
				...
				<div className={styles.rightSide}>
					...
					<img width={68} height={22} src="/img/visa-mastercard.jpg" alt="Cards" />
				</div>
			</div>
		</footer>
	)
